...
<nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
    <div class="container">
        ...
        <a class="navbar-brand text-brand" href="/"><span class="color-b">Duygu Emlak</span></a>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item" href="{{route('categoryhouses',['id'=>$rs->id,'slug'=>$rs->slug])}}">{{$rs->title}}</a>
                        @endforeach
                    </div>
                </li>
            @auth
